...
interface FieldAnimationProps {
  eventId: string
  result: number | null      // numeric result (inches for LJ/SP, feet for discus/javelin)
  isSpecial: boolean
  onComplete?: () => void
}
...
export function FieldAnimation({ eventId, result, isSpecial, onComplete }: FieldAnimationProps) {
  ...
  return (
    <div className="field-animation" ref={containerRef}>
